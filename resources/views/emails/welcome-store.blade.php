...
<head>
    ...
    <title>Welcome to Hani App - Store Registration</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h2>Welcome to Hani App - Store Registration!</h2>
        </div>

        <div class="success">
            <strong>🎉 Congratulations!</strong> Your store account has been successfully verified and activated.
        </div>

        <div class="welcome-section">
            <h3>Hello {{ $user->name }}!</h3>
            <p>Welcome to Hani App as a store partner! Your store "{{ $store->store_name }}" has been successfully registered and verified. You can now start creating offers and attracting customers.</p>
        </div>
        ...
        <div class="documents-section">
            ...
            <p>To complete your store setup and unlock all features, please prepare the following documents:</p>
        ...
        <div class="warning">
            ...
            You can upload these documents through the app to complete your store verification.
        </div>
        @endif
        ...
        <div class="welcome-section">
            <h4>What's Next for Your Store?</h4>
            <ul style="text-align: left; max-width: 400px; margin: 0 auto;">
                <li>Complete your store profile information</li>
                <li>Upload required business documents</li>
                <li>Create your first offers and discounts</li>
